      ...
      <div className="HomePageMainDiv">
       ...
       <div className="HomePageContainer1">
        ...
        <div className="HomePageContainer5">
          ...
          <div>
            <h2>Achieve high profitability by using time tracker</h2>
            <ul typeof="disc">
        ...
        <div className="HomePageContainer4">
          <div>
            <h2>Improve attendance with time off tracking software</h2>
            <ul typeof="disc">
        ...
        <div className="HomePageContainer7">
          <div>
            <h2>Integrate time tracker tool with 50+ popular services</h2>
            <p>
